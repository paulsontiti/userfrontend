          ...
          >
            <CardContent>
              ...
              >
                ...
                <Typography variant='caption'>{`${item.discount} discount`}</Typography>

                <Typography variant='caption'>{`${item.timeLeft} left`}</Typography>
              </Stack>
            </CardContent>
          </Card>
        ))}
...
export default MobileDailySalesPromo;
